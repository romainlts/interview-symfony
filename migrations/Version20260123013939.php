 ...
 */
final class Version20260123013939 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE beneficiary ADD COLUMN creator_email VARCHAR(180) DEFAULT NULL');
        $this->addSql('ALTER TABLE beneficiary ADD COLUMN created_at DATETIME DEFAULT NULL');
